...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int size, @Nullable String carNum, float logoPercent) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", "4", Color.BLACK, Color.WHITE, null, carNum, logoPercent);
    }
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size,
                                            ...
                                            @Nullable String carNum, float logoPercent) {
        ...
        try {
            ...
            /** 5.为二维码添加logo小图标 */
            if (carNum != null) {
                return addLogo(bitmap, carNum, logoPercent);
            }
     ...
     */
    @Nullable
    private static Bitmap addLogo(@Nullable Bitmap srcBitmap, @Nullable String carNum, float logoPercent) {
        ...
        logoBitmap = getNewBitMap(carNum,40,40);
     ...
     * @return
     */
    public static Bitmap getNewBitMap(String text, int height, int width) {
