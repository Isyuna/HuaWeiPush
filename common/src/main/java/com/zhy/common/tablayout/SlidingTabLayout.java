...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSelectSize, sp2px(16));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorColors != null) {
                    mIndicatorDrawable.setColors(mIndicatorColors); //添加颜色组
                } else {
            ...
            if (mIndicatorHeight > 0) {
                ...
                mIndicatorDrawable.setOrientation(GradientDrawable.Orientation.RIGHT_LEFT);//设置渐变方向
