package com.zhy.common.tablayout;
...
import com.zhy.common.R;
import com.zhy.common.tablayout.listener.CustomTabEntity;
import com.zhy.common.tablayout.listener.OnTabSelectListener;
import com.zhy.common.tablayout.utils.FragmentChangeManager;
import com.zhy.common.tablayout.utils.UnreadMsgUtils;
import com.zhy.common.tablayout.widget.MsgView;
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    ...
                    if (mListener != null) {
                        ...
                        mListener.onTabSameSelect(position);
                    }
                }
            }
        });
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                if (tabEntity.getTabSelectedIconUrl() != null && !tabEntity.getTabUnSelectedIconUrl().equals("")) {
                    iv_tab_icon.setImageURI(Uri.fromFile(new File(i == mCurrentTab  ? tabEntity.getTabSelectedIconUrl() : tabEntity.getTabUnSelectedIconUrl())));
                } else {
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            CustomTabEntity tabEntity = mTabEntitys.get(i);
            if (tabEntity.getTabSelectedIconUrl() != null && !tabEntity.getTabUnSelectedIconUrl().equals("")) {
                iv_tab_icon.setImageURI(Uri.fromFile(new File(isSelect ? tabEntity.getTabSelectedIconUrl() : tabEntity.getTabUnSelectedIconUrl())));
            } else {
