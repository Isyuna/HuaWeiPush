 ...
 * description :
 **/
public class ZYVideoPlayer extends StandardGSYVideoPlayer {
    ...
    public ZYVideoPlayer(Context context, Boolean fullFlag) {
    ...
    public ZYVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        ZYVideoPlayer sampleCoverVideo = (ZYVideoPlayer) gsyBaseVideoPlayer;
    ...
    public GSYBaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        //下面这里替换成你自己的强制转化
        ZYVideoPlayer sampleCoverVideo = (ZYVideoPlayer) super.showSmallVideo(size, actionBar, statusBar);
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        ZYVideoPlayer sf = (ZYVideoPlayer) from;
        ZYVideoPlayer st = (ZYVideoPlayer) to;
    ...
    protected void clearFullscreenLayout() {
        ...
        if (oldF != null) {
            ...
            ZYVideoPlayer gsyVideoPlayer = (ZYVideoPlayer) oldF;
